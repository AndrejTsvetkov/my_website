...
# We use AWS S3 only for production, for development we use standard Media and Static settings from settings_dev.py
if os.environ.get('DJANGO_DEVELOPMENT'):
    ...
    DEFAULT_FILE_STORAGE = 'core.custom_storage.PublicMediaStorage'
